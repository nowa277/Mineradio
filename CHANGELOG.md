...
- 新增“火星灯光秀”视觉预设：正式收录 MARS CONCERT、玫瑰花束、人物与猫三幅已验收无人机图案，支持专辑色流动、节拍呼吸、3D 镜头预览和上下翻转查看。
- 搜索栏新增网易云专辑搜索入口，可查看专辑曲目并一键播放或追加到当前队列。
- Fork 发布源切换到 `nowa277/Mineradio`，AppImage 构建与本地菜单覆盖安装以 fork 版本为准。
